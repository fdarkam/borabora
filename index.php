      ...
      <div class="grid_8">
        ...
        <div class="box-3">
          <div>
            ...
            <a href="/borabora/nos-prestations.php#spa" class="link-2">Spa</a>
            <p>Avec piscine intérieure chauffée, sauna, jacuzzi</p>
          </div>
          <div>
            <img src="img/golf.jpg" alt="Golf" class="img-border size-1" />
            <a href="/borabora/nos-prestations.php#golf" class="link-2">Golf</a>
            <p>1 parcours de golf 15 trous</p>
          </div>
          <div class="last">
            <img src="img/seminaire.jpg" alt="Séminaires / Mariages" class="img-border size-1" />
            <a href="/borabora/nos-prestations.php#seminaires" class="link-2">Séminaires / Mariages</a>
            <p>Des salles et salons adaptables à vos besoins</p>
          </div>
        </div>
        <a href="/borabora/nos-prestations.php" class="button top-4">En savoir plus ...</a>
      </div>
